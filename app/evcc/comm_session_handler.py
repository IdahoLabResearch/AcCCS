...
from app.evcc.transport.tcp_client import TCPClient
...
from app.shared.messages.sdp import SDPRequest, SDPResponse, Security, Transport
...
class EVCCCommunicationSession(V2GCommunicationSession):
    ...
    def __init__(
        ...
        from app.evcc.states.sap_states import SupportedAppProtocol
