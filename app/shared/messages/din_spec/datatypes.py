...
from pydantic import Field, conbytes, model_validator
...
class Parameter(BaseModel):
    ...
    def at_least_one_parameter_value(cls, values: Any) -> Any:
        """
...
class DCEVChargeParameter(EVChargeParameter):
    ...
    ev_maximum_voltage_limit: Optional[PVEVMaxVoltageLimitDin] = Field(
