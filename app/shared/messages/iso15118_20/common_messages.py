...
class AuthorizationSetupRes(V2GResponse):
    ...
    eim_as_res: Optional[EIMAuthSetupResParams] = Field(None, alias="EIM_ASResAuthorizationMode")
...
class PnCAuthReqParams(BaseModel):
    ...
    # 'Id' is actually an XML attribute, but JSON (our serialisation method)
    # doesn't have attributes. The EXI codec has to en-/decode accordingly.
    id: Optional[str] = Field(None, max_length=255, alias="Id")
    gen_challenge: bytes = Field(
        ..., min_length=16, max_length=16, alias="GenChallenge"
    )
...
class AuthorizationReq(V2GRequest):
    ...
    pnc_params: Optional[PnCAuthReqParams] = Field(None, alias="PnC_AReqAuthorizationMode")
    eim_params: Optional[EIMAuthReqParams] = Field(None, alias="EIM_AReqAuthorizationMode")
...
class ServiceDiscoveryReq(V2GRequest):
    ...
    supported_service_ids: Optional[ServiceIDList] = Field(None, alias="SupportedServiceIDs")
...
class ServiceDiscoveryRes(V2GResponse):
    ...
    vas_list: Optional[ServiceList] = Field(None, alias="VASList")
...
class Parameter(BaseModel):
    ...
    rational_number: Optional[RationalNumber] = Field(None, alias="rationalNumber")
    finite_str: Optional[Name] = Field(None, alias="finiteString")
...
class ServiceSelectionReq(V2GRequest):
    ...
    selected_vas_list: Optional[SelectedServiceList] = Field(None, alias="SelectedVASList")
...
class ScheduledScheduleExchangeReqParams(BaseModel):
    ...
    ev_target_energy_request: Optional[RationalNumber] = Field(
        None, alias="EVTargetEnergyRequest"
    )
    ev_max_energy_request: Optional[RationalNumber] = Field(None, alias="EVMaximumEnergyRequest")
    ev_min_energy_request: Optional[RationalNumber] = Field(None, alias="EVMinimumEnergyRequest")
    ev_energy_offer: Optional[EVEnergyOffer] = Field(None, alias="EVEnergyOffer")
...
class DynamicScheduleExchangeReqParams(BaseModel):
    ...
    min_soc: Optional[int] = Field(None, ge=0, le=100, alias="MinimumSOC")
    # XSD type byte with value range [0..100]
    target_soc: Optional[int] = Field(None, ge=0, le=100, alias="TargetSOC")
...
class ScheduleExchangeReq(V2GRequest):
    ...
    scheduled_params: Optional[ScheduledScheduleExchangeReqParams] = Field(
        None, alias="Scheduled_SEReqControlMode"
    )
    dynamic_params: Optional[DynamicScheduleExchangeReqParams] = Field(
...
class PowerScheduleEntry(BaseModel):
    ...
    duration: int = Field(..., alias="Duration")
    power: RationalNumber = Field(..., alias="Power")
    power_l2: Optional[RationalNumber] = Field(None, alias="Power_L2")
    power_l3: Optional[RationalNumber] = Field(None, alias="Power_L3")
...
class PowerSchedule(BaseModel):
    ...
    time_anchor: int = Field(..., alias="TimeAnchor")
    available_energy: Optional[RationalNumber] = Field(None, alias="AvailableEnergy")
    power_tolerance: Optional[RationalNumber] = Field(None, alias="PowerTolerance")
...
class PriceSchedule(BaseModel):
    ...
    schedule_description: Optional[Description] = Field(None, alias="PriceScheduleDescription")
...
class TaxRule(BaseModel):
    ...
    tax_rule_name: Optional[Name] = Field(None, alias="TaxRuleName")
    tax_rate: RationalNumber = Field(..., alias="TaxRate")
    tax_included_in_price: Optional[bool] = Field(None, alias="TaxIncludedInPrice")
...
class PriceRule(BaseModel):
    ...
    energy_fee: RationalNumber = Field(..., alias="EnergyFee")
    parking_fee: Optional[RationalNumber] = Field(None, alias="ParkingFee")
    parking_fee_period: Optional[int] = Field(None, le=UINT_32_MAX, alias="ParkingFeePeriod")
    carbon_dioxide_emission: Optional[int] = Field(
        None, le=UINT_16_MAX, alias="CarbonDioxideEmission"
    )
    # XSD type unsignedByte with value range [0..255]
    renewable_energy_percentage: Optional[int] = Field(
...
class OverstayRule(BaseModel):
    ...
    description: Optional[Description] = Field(None, alias="OverstayRuleDescription")
...
class OverstayRuleList(BaseModel):
    ...
    time_threshold: Optional[int] = Field(
...
class AbsolutePriceSchedule(PriceSchedule):
    ...
    price_algorithm: str = Field(..., max_length=255, alias="PriceAlgorithm")
    min_cost: Optional[RationalNumber] = Field(None, alias="MinimumCost")
    max_cost: Optional[RationalNumber] = Field(None, alias="MaximumCost")
    tax_rules: Optional[TaxRuleList] = Field(None, alias="TaxRules")
    price_rule_stacks: PriceRuleStackList = Field(..., alias="PriceRuleStacks")
    overstay_rules: Optional[OverstayRuleList] = Field(
        None, alias="OverstayRules"
    )
    additional_services: Optional[AdditionalServiceList] = Field(
...
class ChargingSchedule(BaseModel):
    ...
    price_level_schedule: Optional[PriceLevelSchedule] = Field(
        None, alias="PriceLevelSchedule"
    )
    absolute_price_schedule: Optional[AbsolutePriceSchedule] = Field(
...
class ScheduleTuple(BaseModel):
    ...
    discharging_schedule: Optional[DischargingSchedule] = Field(
        None, alias="DischargingSchedule"
    )
...
class DynamicScheduleExchangeResParams(BaseModel):
    ...
    departure_time: Optional[int] = Field(
        None, ge=0, le=UINT_32_MAX, alias="DepartureTime"
    )
    # XSD type byte with value range [0..100]
    min_soc: Optional[int] = Field(None, ge=0, le=100, alias="MinimumSOC")
    # XSD type byte with value range [0..100]
...
class ScheduleExchangeRes(V2GResponse):
    ...
    evse_processing: Processing = Field(..., alias="EVSEProcessing")
    scheduled_params: Optional[ScheduledScheduleExchangeResParams] = Field(
        None, alias="Scheduled_SEResControlMode"
    )
    dynamic_params: Optional[DynamicScheduleExchangeResParams] = Field(
        None, alias="Dynamic_SEResControlMode"
    )
    go_to_pause: Optional[bool] = Field(None, alias="GoToPause")
...
class EVPowerProfile(BaseModel):
    ...
    scheduled_profile: Optional[ScheduledEVPowerProfile] = Field(
        None, alias="Scheduled_EVPPTControlMode"
    )
    dynamic_profile: Optional[DynamicEVPowerProfile] = Field(
...
class PowerDeliveryReq(V2GRequest):
    ...
    ev_power_profile: Optional[EVPowerProfile] = Field(
        None, alias="EVPowerProfile"
    )
    bpt_channel_selection: Optional[ChannelSelection] = Field(
        None, alias="BPT_ChannelSelection"
    )
...
class PowerDeliveryRes(V2GResponse):
    ...
    evse_status: Optional[EVSEStatus] = Field(None, alias="EVSEStatus")
...
class SignedMeteringData(BaseModel):
    ...
    scheduled_smart_meter_data: Optional[ScheduledSignedMeterData] = Field(
        None, alias="Scheduled_SMDTControlMode"
    )
    dynamic_smart_meter_data: Optional[DynamicSignedMeterData] = Field(
...
class SessionStopReq(V2GRequest):
    ...
    ev_termination_code: Optional[Name] = Field(
        None, alias="EVTerminationCode"
    )
    ev_termination_explanation: Optional[str] = Field(
...
class CertificateInstallationReq(V2GRequest):
    ...
    prioritized_emaids: Optional[EMAIDList] = Field(
        None, alias="PrioritizedEMAIDs"
    )
...
class VehicleCheckInReq(V2GRequest):
    ...
    parking_method: Optional[ParkingMethod] = Field(
        None, alias="ParkingMethod"
    )
...
class VehicleCheckInRes(V2GResponse):
    ...
    target_offset: Optional[TargetPosition] = Field(None, alias="TargetOffset")
