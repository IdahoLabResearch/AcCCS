...
from app.shared.messages.datatypes import get_exponent_value_repr
...
from app.shared.messages.xmldsig import Signature, X509IssuerSerial
...
class DisplayParameters(BaseModel):
    ...
    present_soc: Optional[int] = Field(None, ge=0, le=100, alias="PresentSOC")
    # XSD type byte with value range [0..100]
    ...
    # XSD type byte with value range [0..100]
    max_soc: Optional[int] = Field(None, ge=0, le=100, alias="MaximumSOC")
    remaining_time_to_min_soc: Optional[int] = Field(
        None, alias="RemainingTimeToMinimumSOC"
    )
    remaining_time_to_target_soc: Optional[int] = Field(
        None, alias="RemainingTimeToTargetSOC"
    )
    remaining_time_to_max_soc: Optional[int] = Field(
        None, alias="RemainingTimeToMaximumSOC"
    )
    charging_complete: bool = Field(..., alias="ChargingComplete")
    battery_energy_capacity: Optional[RationalNumber] = Field(
        None, alias="BatteryEnergyCapacity"
    )
    inlet_hot: Optional[bool] = Field(None, alias="InletHot")
...
class ChargeLoopReq(V2GRequest, ABC):
    ...
    display_parameters: Optional[DisplayParameters] = Field(
        None, alias="DisplayParameters"
    )
...
class MeterInfo(BaseModel):
    ...
    meter_signature: Optional[bytes] = Field(
        None, max_length=64, alias="MeterSignature"
    )
    meter_status: Optional[int] = Field(None, alias="MeterStatus")
    meter_timestamp: Optional[int] = Field(None, alias="MeterTimestamp")
...
class Receipt(BaseModel):
    ...
    energy_costs: Optional[DetailedCost] = Field(None, alias="EnergyCosts")
    occupancy_costs: Optional[DetailedCost] = Field(
        None, alias="OccupancyCosts"
    )
    additional_services_costs: Optional[DetailedCost] = Field(
...
class ScheduledChargeLoopReqParams(BaseModel, ABC):
    ...
    ev_max_energy_request: Optional[RationalNumber] = Field(
        None, alias="EVMaximumEnergyRequest"
    )
    ev_min_energy_request: Optional[RationalNumber] = Field(
        None, alias="EVMinimumEnergyRequest"
    )
...
class DynamicChargeLoopResParams(BaseModel):
    ...
    # XSD type byte with value range [0..100]
    target_soc: Optional[int] = Field(None, ge=0, le=100, alias="TargetSOC")
    ack_max_delay: Optional[int] = Field(None, alias="AckMaxDelay")
