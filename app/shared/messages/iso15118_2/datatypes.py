...
from pydantic import (
    Field, conbytes, constr, model_validator, field_validator,
    ValidationInfo
)
...
class SalesTariffEntry(BaseModel):
    ...
    @classmethod
    def at_least_one_cost_indicator(cls, value, info: ValidationInfo):
        """
...
class SalesTariff(BaseModel):
    ...
    @classmethod
    def check_num_e_price_levels(cls, value, info: ValidationInfo):
        """
    ...
    @field_validator("sales_tariff_id")
    @classmethod
