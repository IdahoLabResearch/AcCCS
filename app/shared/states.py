...
from app.shared.messages.din_spec.body import Body as BodyDINSPEC
from app.shared.messages.din_spec.body import BodyBase as BodyBaseDINSPEC
from app.shared.messages.din_spec.datatypes import FaultCode as FaultCodeDINSPEC
from app.shared.messages.din_spec.datatypes import (
    Notification as NotificationDINSPEC,
)
from app.shared.messages.din_spec.header import (
...
from app.shared.messages.din_spec.timeouts import Timeouts as TimeoutsDIN
from app.shared.messages.iso15118_2.body import Body, BodyBase
from app.shared.messages.iso15118_2.datatypes import FaultCode, Notification
...
from app.shared.messages.iso15118_2.timeouts import Timeouts as TimeoutsV2
from app.shared.messages.iso15118_20.common_types import (
    V2GMessage as V2GMessageV20,
)
from app.shared.messages.iso15118_20.timeouts import Timeouts as TimeoutsV20
...
if TYPE_CHECKING:
    ...
    from app.secc.comm_session_handler import SECCCommunicationSession
...
class State(ABC):
    ...
    def __init__(
        ...
        timeout: Union[TimeoutsDIN, TimeoutsV2, TimeoutsV20] = 0,
    ):
        """
        ...
        self.timeout: Union[TimeoutsDIN, TimeoutsV2, TimeoutsV20] = 0
        ...
        self.next_msg_timeout: Union[TimeoutsDIN, TimeoutsV2, TimeoutsV20] = 0
    ...
    def create_next_message(
        ...
        next_msg_timeout: Union[TimeoutsDIN, TimeoutsV2, TimeoutsV20],
        namespace: Namespace,
        ...
        if isinstance(next_msg, BodyBaseDINSPEC):
            ...
            body_dinspec: BodyDINSPEC = BodyDINSPEC.model_validate(
                {str(next_msg): next_msg.model_dump()}
            )
            try:
            ...
            body: Body = Body.model_validate({str(next_msg): next_msg.model_dump()})
            try:
