...
from app.shared.messages.datatypes import SelectedService as SelectedServiceV2_DIN
...
from app.shared.states import Pause, State, Terminate
...
class V2GCommunicationSession(SessionStateMachine):
    ...
    async def stop(self, reason: str):
        ...
        logger.info(
            f"The data link will {terminate_or_pause.value} in 2 seconds and "
        ...
        logger.info(f"{terminate_or_pause.value.capitalize()}d the data link")
