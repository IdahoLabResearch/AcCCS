...
from app.shared.messages.din_spec.body import CableCheckReq as CableCheckReqDINSPEC
from app.shared.messages.din_spec.body import CableCheckRes as CableCheckResDINSPEC
...
from app.shared.messages.din_spec.body import PreChargeReq as PreChargeReqDINSPEC
from app.shared.messages.din_spec.body import PreChargeRes as PreChargeResDINSPEC
from app.shared.messages.din_spec.body import (
...
from app.shared.messages.din_spec.datatypes import ServiceID as ServiceIDDINSPEC
...
from app.shared.messages.iso15118_2.body import SessionStopReq as SessionStopReqV2
from app.shared.messages.iso15118_2.body import SessionStopRes as SessionStopResV2
from app.shared.messages.iso15118_2.body import (
...
def init_failed_responses_din_spec_70121() -> dict:
    ...
    failed_response_iso_dinspec = {
        ...
        CurrentDemandReqDINPEC: CurrentDemandResDINSPEC(
            ...
            evse_present_current=PVEVSEPresentCurrentDin(
                multiplier=0, value=0, unit=UnitSymbol.AMPERE
            ),
            evse_current_limit_achieved=False,
            evse_voltage_limit_achieved=False,
            evse_power_limit_achieved=False,
            evse_max_voltage_limit=PVEVSEMaxVoltageLimitDin(
                multiplier=0, value=0, unit=UnitSymbol.VOLTAGE
            ),
            evse_max_current_limit=PVEVSEMaxCurrentLimitDin(
                multiplier=0, value=0, unit=UnitSymbol.AMPERE
            ),
            evse_max_power_limit=PVEVSEMaxPowerLimitDin(
                multiplier=0, value=0, unit=UnitSymbol.WATT
            ),
        ),
