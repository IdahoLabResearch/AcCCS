...
from app.secc.controller.interface import AuthorizationResponse
    ...
    def validate_message_signature(self, message: V2GMessageV2) -> bool:
        ...
        return verify_signature(
            ...
            elements_to_sign=[
                (
                    cert_install_req.id,
                    EXI().to_exi_fragment(cert_install_req, Namespace.ISO_V2_MSG_DEF),
                )
            ],
        ...
        if not self.comm_session.contract_cert_chain:
            ...
            [
                (
                    ...
                    EXI().to_exi_fragment(metering_receipt_req, Namespace.ISO_V2_MSG_DEF),
                )
            ],
