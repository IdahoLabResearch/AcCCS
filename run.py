...
parser = argparse.ArgumentParser(description="Emulator for AcCCS")
parser.add_argument("-e", "--emulator", nargs=1, help="Specify emulator type")
parser.add_argument(
    "-M",
    "--mode",
    nargs=1,
...
if args.emulator[0] == "evcc":
    pev = PEV(args)
    pev.start()
elif args.emulator[0] == "secc":
    evse = EVSE(args)
    evse.start()
else:
